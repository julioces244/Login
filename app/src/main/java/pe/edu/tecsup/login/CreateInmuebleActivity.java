...
//        }
        ...
        if (mediaFileUri == null) {
            String coord = "-12.055254427295868 -76.96713541535695";
            // Si no se incluye imagen hacemos un envío POST simple
            call = service.createInmueble(direccion,coord, descripcion, tipocosto,costo,identificador);
        } else {
            ...
            RequestBody nombrePart = RequestBody.create(MultipartBody.FORM, direccion);
            RequestBody precioPart = RequestBody.create(MultipartBody.FORM, descripcion);
            RequestBody detallesPart = RequestBody.create(MultipartBody.FORM, tipocosto);
            ...
            call = service.createInmuebleWithImage(nombrePart, precioPart, detallesPart,identificadorPart,imagenPart);
        }
