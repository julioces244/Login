                ...
                if(resultCode == Activity.RESULT_OK){
                    ...
                    if(data.getExtras() != null) {
                        ...
                        if (CreateInmuebleActivity.this != null)
                            Toast.makeText(CreateInmuebleActivity.this, "Geolocalización actualizada", Toast.LENGTH_LONG).show();
...
//        }
        ...
        if (mediaFileUri == null) {
            ...
            RequestBody nombrePart = RequestBody.create(MultipartBody.FORM, dir);
            RequestBody precioPart = RequestBody.create(MultipartBody.FORM, descripcion);
            RequestBody detallesPart = RequestBody.create(MultipartBody.FORM, tp);
